      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-16">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            As a highly motivated engineering student, I have
            excelled in my coursework and gained hands-on
            experience through various projects. I am a
            collaborative team player with excellent
            communication and problem-solving abilities. With a
            passion for innovation and a dedication to lifelong
            learning, I am eager to contribute to the success of any
            organization I join.
            </p>
            <div className="max-w-xs mx-auto sm:max-w-none sm:flex sm:justify-center">
              ...
              <div data-aos="fade-up" data-aos-delay="600">
                <a className="btn text-black bg-purple-600 hover:bg-purple-700 w-full sm:w-auto sm:ml-4" href="#0">
                  About Me
                </a>
              </div>
            </div>
